...
function AdminDashboard() {
    ...
    return (<div className="min-h-screen bg-gray-50">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {orders.map((order) => (<tr key={order.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                        <button onClick={() => router.push(`/admin/orders/${order.id}`)} className="text-blue-600 hover:text-blue-800">
                          Подробнее
                        </button>
                        <button onClick={() => {
      ...
      {selectedOrder && (<div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select value={newStatus} onChange={(e) => setNewStatus(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#303030] focus:border-[#303030]">
              ...
              <div>
                ...
                <textarea value={adminComment} onChange={(e) => setAdminComment(e.target.value)} rows={3} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#303030] focus:border-[#303030]" placeholder="Дополнительная информация для клиента..."/>
              </div>
            </div>

            <div className="mt-6 flex space-x-3">
              <button onClick={updateOrderStatus} disabled={isUpdating} className="flex-1 bg-[#303030] text-white px-4 py-2 rounded-md hover:bg-[#404040] disabled:opacity-50">
